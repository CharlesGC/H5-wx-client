...
export class ConsultantProjectBrowserPage {
  ...
  public attstate: any
  constructor(public navCtrl: NavController, public navParams: NavParams, private Provider: MamenDataProvider, public platform: Platform, private app: App, public modalCtrl: ModalController, private http: HttpClient) {
