...
//隐藏底部分享菜单
  ...
  onProjectReleaseSubmit(pid) {
    ...
    !this.projectDetails['target'] || !this.projectDetails['pSkill'] || 
    !this.projectDetails['pIndustry'] || !this.projectDetails['budgetDay'] || 
    !this.projectDetails['workload'] || !this.projectDetails['budget'] || 
    !this.projectDetails['startTime'] || !this.projectDetails['projectLengthType'] || 
    !this.projectDetails['deliverMethod'] || !this.projectDetails['qualification'] || 
    !this.projectDetails['planguage'] || !this.projectDetails['companyName'] || 
    !this.projectDetails['principalName'] || !this.projectDetails['principalPhone'] || 
    !this.projectDetails['principalEmail']){
