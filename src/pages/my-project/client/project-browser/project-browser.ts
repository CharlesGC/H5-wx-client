...
import {
  getProjectDetailUrl, releaseProjectUrl, getProjectSignUpAdviserCountUrl,
  getProjectProgramCountUrl, getProjectStageCountUrl, getProjectDocumentCountUrl, hideAttentionMenuUrl, getAttentionUserInfo,sourceHistoryUrl
} from '../../../../providers/requestUrl';
      ...
      if (res['code'] == 200) {
        ...
        wx.ready(function () {
          ...
          wx.onMenuShareAppMessage({
            ...
            link: sourceHistoryUrl + '&page=8&pid='+data.pid,
            // 分享图标 
